...
// Regex for valid variable names (https://stackoverflow.com/a/9337047)
...
function deobfuscate(source) {
        ...
        */
        ...
        VariableDeclaration(path) {
            ...
            if (functionNameMap && !stringArrName) {
                ...
                lookupTable = functionNameMap.init.elements.map(n => n.value);

                // remove the variable from the code because it's
        ...
        MemberExpression(path) {
            // If we find a MemberExpression who's object's name equals the
    ...
    // This changes all of the StringLiterals into Identifiers if it can.
